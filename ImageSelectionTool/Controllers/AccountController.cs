...
using ImageSelectionTool.Providers;
using ImageSelectionTool.Results;
using ImageSelectionTool.Models.Utility;
using System.Net;
        ...
        public async Task<HttpResponseMessage> Register(RegisterBindingModel model)
        {
            ...
            if (errors.Count == 0)
            {
                ...
                if (UserManager.FindByEmail(model.UserName) == null)
                {
                    ...
                    return Request.CreateResponse(HttpStatusCode.NotAcceptable, "User Name is already in use.");
            }
            else
